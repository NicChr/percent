...
To avoid this task of always multiplying by 100, one can just create a simple wrapper.

The reason this isn't already implemented is because percent is designed to be lightweight and has only one function `percent`.
